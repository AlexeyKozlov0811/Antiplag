...
def GetSimilarAreasDefinition(text1_dictionary: Dict[int, str],
                              compared_texts: Dict[Tuple[int], List[Union[int, str]]],
                              text_type=0)\
        -> Union[Dict[Union[int, Tuple[int]], List[Union[int, str]]], List[str]]:
    areas = []
    new_list_of_areas = []
    defined_area = ""
    word = ""
...
def RemoveDuplicates(old_similar_phrases: Dict[Tuple[int], List[int]],
                     new_similar_phrases: Dict[int, List[int]]) -> Dict[Tuple[int], List[int]]:
    duplicates_keys = []
    transformed_dict = {}
